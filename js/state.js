...
// We need a way to update the state from other modules, especially after loading from localStorage.
// These functions will allow controlled mutation of the state.
...
export function updateProviders(customProviders) {
